...
class Mock {
    private val ALL = MotivationConstants.FHRASEFILTER.ALL
    private val MORNING = MotivationConstants.FHRASEFILTER.MORNING
    private val HAPPY = MotivationConstants.FHRASEFILTER.HAPPY
